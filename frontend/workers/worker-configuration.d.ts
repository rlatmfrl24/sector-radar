/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ingest.jsonc workers/worker-configuration.d.ts` (hash: 0a11a4171dbae10789ab11dc248987dd)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REFRESH_INTERVAL_MINUTES" | "ENABLE_INTRADAY_CORE_REFRESH" | "YAHOO_CORE_FETCH_BUDGET" | "YAHOO_FETCH_BUDGET" | "YAHOO_HOLDINGS_FETCH_BUDGET" | "YAHOO_FETCH_CONCURRENCY" | "FRED_REFRESH_INTERVAL_MINUTES" | "ENABLE_KRX_CONTEXT_REFRESH" | "KRX_REFRESH_INTERVAL_MINUTES" | "KRX_CONTEXT_ENDPOINT">> {}
}
