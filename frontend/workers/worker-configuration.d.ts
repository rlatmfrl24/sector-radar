/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ingest.jsonc workers/worker-configuration.d.ts` (hash: 27d4d13ead7d63defb19b20ca1a8311f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REFRESH_INTERVAL_MINUTES" | "YAHOO_FETCH_BUDGET" | "YAHOO_FETCH_CONCURRENCY">> {}
}
