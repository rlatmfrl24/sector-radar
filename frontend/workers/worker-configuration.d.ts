/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ingest.jsonc workers/worker-configuration.d.ts` (hash: 440e5a3299f3069e81a0336ccb484cd5)
...
interface __BaseEnv_Env {
	...
	KRX_CONTEXT_ENDPOINT: "https://data-dbg.krx.co.kr/svc/apis/sto/stk_bydd_trd,https://data-dbg.krx.co.kr/svc/apis/sto/ksq_bydd_trd";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./ingest/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REFRESH_INTERVAL_MINUTES" | "ENABLE_INTRADAY_CORE_REFRESH" | "YAHOO_CORE_FETCH_BUDGET" | "YAHOO_FETCH_BUDGET" | "YAHOO_HOLDINGS_FETCH_BUDGET" | "YAHOO_FETCH_CONCURRENCY" | "YAHOO_FETCH_TIMEOUT_MS" | "VALIDATION_HISTORY_DAYS" | "FRED_REFRESH_INTERVAL_MINUTES" | "ENABLE_KRX_CONTEXT_REFRESH" | "KRX_REFRESH_INTERVAL_MINUTES" | "KRX_CONTEXT_ENDPOINT">> {}
}
