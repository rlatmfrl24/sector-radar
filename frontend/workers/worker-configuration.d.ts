/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ingest.jsonc workers/worker-configuration.d.ts` (hash: df576071fbae4d3d682f2e3d95c321d8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REFRESH_INTERVAL_MINUTES" | "ENABLE_INTRADAY_CORE_REFRESH" | "YAHOO_CORE_FETCH_BUDGET" | "YAHOO_FETCH_BUDGET" | "YAHOO_HOLDINGS_FETCH_BUDGET" | "YAHOO_FETCH_CONCURRENCY">> {}
}
