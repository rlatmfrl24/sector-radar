/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ingest.jsonc workers/worker-configuration.d.ts` (hash: ba88831d558b32e91fa116158c554e65)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REFRESH_INTERVAL_MINUTES" | "ENABLE_INTRADAY_CORE_REFRESH" | "YAHOO_CORE_FETCH_BUDGET" | "YAHOO_FETCH_BUDGET" | "YAHOO_HOLDINGS_FETCH_BUDGET" | "YAHOO_FETCH_CONCURRENCY" | "FRED_REFRESH_INTERVAL_MINUTES" | "KRX_REFRESH_INTERVAL_MINUTES" | "KRX_CONTEXT_ENDPOINT">> {}
}
