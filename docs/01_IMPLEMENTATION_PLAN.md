...
- React + Vite dashboard: compact top bar, Layer 1 흐름, Layer 2 여력, Layer 3 리더십 상세
...
4. 공통 상태: provider status, layer-scoped source freshness, validation gate
...
| 4주차 | Rulebook + Dashboard | narrative, risks, invalidation, 3-layer MVP UI |
...
10. React 3-layer dashboard scaffold 구현
